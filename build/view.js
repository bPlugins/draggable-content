...
const Style = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		${cardSl} {
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(body.radius))}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("width", body.width)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("height", body.height)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderBoxCSS)(body.border)}
			box-shadow:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getMultiShadowCSS)(body.shadow)};
		}
		${bodySl}{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBackgroundCSS)(body.bg)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(body.padding))}
		}
		${badgeSl}{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("width", badge.width)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("height", badge.height)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(badge.radius))}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderBoxCSS)(badge.border)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBackgroundCSS)(badge.bg)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(badge.padding))}
		}
	`
    }
  });
...
/***/ "./src/Components/Frontend/Draggable.js":
/*!**********************************************!*\
  !*** ./src/Components/Frontend/Draggable.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Draggable = ({
  ...
  const [offset, setOffset] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(container.position || {
    x: 0,
    y: 0
  });
  ...
  const draggElRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  // useEffect(() => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "drgable-card"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "drgable-badge",
    ref: draggElRef,
    dangerouslySetInnerHTML: {
      __html: badge.content
    }
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony import */ var _Components_Frontend_Draggable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Frontend/Draggable */ "./src/Components/Frontend/Draggable.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  draggableEls.forEach(draggableEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(draggableEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes,
      id: draggableEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Frontend_Draggable__WEBPACK_IMPORTED_MODULE_3__["default"], {
      attributes: attributes
    })));
